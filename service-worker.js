// Service worker da Escala Pão & Tradição
// A atualização é automática: a versão nova assume assim que o celular baixa este arquivo.
// Não é preciso reinstalar o app nem trocar o número abaixo a cada publicação.
